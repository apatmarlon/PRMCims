                ...
                <ul class="navbar-nav">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <a class="dropdown-item" href="{{ route('orders.return.index') }}">
                                        {{ __('Returns') }}
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <a class="dropdown-item" href="{{ route('purchases.list') }}">
                                        {{ __('List Purchases') }}
                                    </a>
                    ...
                    <li class="nav-item dropdown {{ request()->is('suppliers*', 'customers*') ? 'active' : null }}">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href="{{ route('reports.pl.index') }}">
                                        {{ __('Profit/Loss Report') }}
                                    </a>

                                    <a class="dropdown-item" href="{{ route('reports.purchase-sale') }}">
                                        {{ __('Purchase & Sale Report') }}
                                    </a>

                                    <a class="dropdown-item" href="{{ route('reports.supplier-customer') }}">
                                        {{ __('Supplier and Customer Report') }}
                                    </a>

                                    {{-- Product Stock Report --}}
                                    <a class="dropdown-item" href="{{ route('reports.product-stock') }}">
                                        {{ __('Product Stock Report') }}
                                    </a>

                                    <a class="dropdown-item" href="{{ route('reports.product-orders') }}">
                                        {{ __('Product Sale Report') }}
                                    </a>

                                     <a class="dropdown-item" href="{{ route('reports.sales-vs-returns') }}">
                                        {{ __('Sales vs Returns Report') }}
                                    </a>

                                    <a class="dropdown-item" href="{{ route('reports.gross_profit') }}">
                    ...
                    <li class="nav-item {{ request()->is('soa*') ? 'active' : null }}">
                        <a class="nav-link" href="{{ route('soa.index') }}" >
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
