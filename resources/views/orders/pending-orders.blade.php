            ...
            <div class="table-responsive">
                <table class="table table-bordered card-table table-vcenter text-nowrap datatable">
                    ...
                    <tbody>
                        ...
                        <td class="text-center">{{ $order->customer->phone ?? 'N/A' }}</td>

                        <td class="text-center">{{ $order->customer->address ?? 'N/A' }}</td>
                        ...
                        <td class="text-center">{{ Number::currency($order->pay, 'PHP') }}</td>

                        <td class="text-center">{{ Number::currency($order->due, 'PHP') }}</td>

                        <td class="text-center">{{ $order->total_products }}</td>

                        <td class="text-center">{{ $order->added_by }}</td>
